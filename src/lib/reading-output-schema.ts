...
export const generatedTitleSchema = z.string().min(35).max(45)
  .describe("공백 포함 35~45자 제목. 쉼표는 정확히 하나이며 'A, B기니' 구조로 쓴다. 마지막 절은 마음을 열었기니·온도를 맞췄기니처럼 완료된 행동 동사+기니로 쓰고, 관계이기니·계기니 같은 명사형은 금지한다. 2번과 5번 장만 기니!로 끝내고 나머지는 기니로 끝낸다. 중괄호와 줄바꿈은 쓰지 않는다.");
